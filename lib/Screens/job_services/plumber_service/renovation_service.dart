...
class RenovationService extends StatefulWidget {
  @override
  _RenovationServiceState createState() => _RenovationServiceState();
}

class _RenovationServiceState extends State<RenovationService> {
  // int counter = 0;
  @override
  Widget build(BuildContext context) {
    int inde;
    int length = renovation.length;
    return Expanded(
      //flex: 10,
                  ...
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Joblist(
                          heading: renovation[index].heading,
                          subheading: renovation[index].subheading,
                          price: renovation[index].price,
                          counter: renovation[index].counter,
                        ),
                      ),
                    ),
                  ),
