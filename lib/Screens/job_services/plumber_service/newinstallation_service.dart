...
class NewInstallationService extends StatefulWidget {
  @override
  _NewInstallationServiceState createState() => _NewInstallationServiceState();
}

class _NewInstallationServiceState extends State<NewInstallationService> {
  // int counter = 0;
  @override
  Widget build(BuildContext context) {
    int inde;
    int length = newInstallation.length;
    return Expanded(
      //flex: 10,
                  ...
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Joblist(
                          heading: newInstallation[index].heading,
                          subheading: newInstallation[index].subheading,
                          price: newInstallation[index].price,
                          counter: newInstallation[index].counter,
                        ),
                      ),
                    ),
                  ),
