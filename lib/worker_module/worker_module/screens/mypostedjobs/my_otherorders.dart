...
class OtherJobOrders extends StatefulWidget {
  OtherJobOrders({Key key}) : super(key: key);

  @override
  _OtherJobOrdersState createState() => _OtherJobOrdersState();
}

class _OtherJobOrdersState extends State<OtherJobOrders> {
  @override
  void initState() {
