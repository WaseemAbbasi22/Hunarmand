...
class AllOtherJobs extends StatefulWidget {
  AllOtherJobs({Key key}) : super(key: key);

  @override
  _AllOtherJobsState createState() => _AllOtherJobsState();
}

class _AllOtherJobsState extends State<AllOtherJobs> {
  @override
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              StreamBuilder<List<Jobs>>(
                ...
                //     .snapshots(),
                stream: jobProvider.allotherjobs,
